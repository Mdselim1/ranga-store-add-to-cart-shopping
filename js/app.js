...
//Find Input Value for price , deliverycharge and total Price function
...
const updateTotal = () => {
  ...
  // console.log(productPrice , deliveryCharge , totalTax)
  const grandTotal = productPrice + deliveryCharge + totalTax; 
